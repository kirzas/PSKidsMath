function Out-KZPrinter {
    <#
      .Synopsis
        Sends output to a printer.
      .Description
        Stolen from https://www.powershellgallery.com/packages/6Print/0.1.0/Content/Out-Printer.ps1
        Recent version of 6Print is only for PowerShell 7 and formatting is broken there

        Out-KZPrinter sends output to the default printer or to an alternate printer,
      ...
      .Example
        > dir | Out-KZPrinter -PrinterName 'Microsoft Print to PDF' -PrintFileName .\files.pdf -LeftMargin 50 -Verbose
      ...
      .Example
        > Out-KZPrinter -Path .\Out-KZPrinter.ps1 -PrinterName 'Microsoft Print to PDF' -PrintFileName .\listing.pdf -Landscape -PaperSize a3 -FontSize 9
      ...
      .Example
        >get-service | ft -a | Out-KZPrinter -Name 'Send To OneNote 2016' -LeftMargin 0 -RightMargin 0 -TopMargin 50 -FontSize 8
